<p align="center">
  <img src="./yyc3-article-cover-05.png" alt="YYC³ Smart City Platform" width="100%" />
</p>
...
[![AI Assistant](https://img.shields.io/badge/AI-Assistant-purple?style=flat-square&logo=robot)](https://github.com/YYC-Cube/yyc3-smart-city-platform)
...
本项目配置了全面的自动化 Pull Request 审核系统，每个 PR 都会自动进行以下检查：
...
**详细说明**: 查看 [PR 自动审核文档](docs/PR-AUTO-REVIEW.md)

提交 PR 时，请：

1. 使用 PR 模板填写完整描述
2. 关联相关 Issue（使用 `Closes #issue_number`）
3. 完成 PR 模板中的检查清单
4. 响应自动审核的反馈
